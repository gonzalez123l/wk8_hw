...
import { ChevronRight,ChevronLeft, Diversity1 } from "@mui/icons-material";
      ...
      <Box sx={{display:'flex'}} >
        ...
        >
          <Toolbar sx={myStyles.toolbar}>
            ...
            {/* Dialof Pop Up Begin Here */}
            <Dialog open={dialogOpen} onClose={handleDialogClickClose} arai-labelldby= 'form-dialog-title'>
              <DialogTitle id= "form-dialog-title">Add New Car</DialogTitle>
              <DialogContent>
                <DialogContentText>Enter Car information below</DialogContentText>
                <CarForm/>
              </DialogContent>
              <DialogActions>
